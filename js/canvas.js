...
class Bubble {
  static COLORS = ["255,108,80", "5,117,18", "29,39,57", "67,189,81"];
  ...
  init() {
    this.color =
      Bubble.COLORS[Math.floor(Math.random() * Bubble.COLORS.length)];
...
class CanvasBackground {
  ...
  generateBubbles() {
    this.bubblesList = [];
    for (let i = 0; i < CanvasBackground.BUBBLE_DENSITY; i++) {
